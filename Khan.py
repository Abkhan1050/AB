...
\033[1;91m☞ Auther     : AB_KHAN_TRICKS-MASTER
\033[1;92m☞ WhatsApp   : 03242625252
\033[1;95m☞ YouTube    : https://www.youtube.com/channel/UCuXunJvSMNB83NM58L8ELXA
\033[1;97m☞ Facbook id : https://www.facebook.com/mustaqeem.ghazlani11
...
def login():
	...
	try:
		...
		if 'access_token' in z:
		    ...
		    os.system('xdg-open https://www.youtube.com/channel/UCuXunJvSMNB83NM58L8ELXA')
		    menu()
		else:
...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update AB_KHAN Tool')
	print (S + '[' + P + '☞3' + S + ']' + S + ' AB KAHN WhatsApp Group')
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $HOME/AB+KHAN')
	    os.system('cd $HOME && git clone https://github.com/abkhan122/Khan')
	    cb()
	    print (logo)
	    psb('☆10%')
	    psb('☆☆20%')
	    ...
	    psb('WhatsApp Num 03242625252✓')
	    psb('WellCome To AB_KHAN')
	    psb('Congratulations AB_KHAN Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ 786786✓')
	    psb('🔓Password ☆ 786786✓')
	    psb('Subscrib My Youtube Channel AB TRICKS MASTER✓')
	    psb('Please Login Again')
	    time.sleep(2)
	    os.system('cd $HOME/AB_KHAN && python2 AB.py')
	elif bm =='3':
	    os.system('xdg-open https://www.facebook.com/103382541895846/posts/110146721219428/?app=fbl')
	    menu()
	elif bm =='4':
